...
public class Enemy : MonoBehaviour//, iEnemy
{
    ...
    public AudioSource enemAttack;
    public AudioSource enemDamage;
    ...
    void Update()
    {
        ...
        if (distanceToPlayer < attackRange)
        {
            ...
            Walking = false;
                ...
                Attacking = true;
                //kommenter ut linja under om enemy ikke funke
                enemAttack.Play();
                //anim.Play("Attack");
            }
        }
        ...
        {
            //rb.position = Vector2.MoveTowards(rb.transform.position, target.position, speed * Time.deltaTime);
